...
func bindLuxUniPKIWeb(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(LuxUniPKIWebABI))
	if err != nil {
		return nil, err
	}
...
//
// Solidity: function EncodeMapID(address _addrContr, uint96 _index) constant returns(uint256 _res)
...
//
// Solidity: function getRegContrAddr(address _addrContr, uint96 _index) constant returns(address)
...
//
// Solidity: function getRegCreationDate(address _addrContr, uint96 _index) constant returns(uint256)
...
//
// Solidity: function getRegDescription(address _addrContr, uint96 _index) constant returns(string)
...
//
// Solidity: function getRegEthAccCA(address _addrContr, uint96 _index) constant returns(address)
...
//
// Solidity: function getRegFileName(address _addrContr, uint96 _index) constant returns(string)
